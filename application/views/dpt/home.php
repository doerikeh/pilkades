    ...
    <div class="box-body">
        ...
        <div class="panel panel-primary">
            <div class="panel-body">
                    ...
                    ?>
                    <div class="col-md-3">
                        <button class="form-control btn btn-default" data-toggle="modal" data-target="#import-dpt"><i class="glyphicon glyphicon glyphicon-floppy-open"></i> Import Data Excel</button>
                    </div>
...
<div class="modal" id="modal_view" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Lihat Detail Dpt</h3>
            </div>
...
<div class="modal" id="modal_join" role="dialog" tabindex="-1" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<?php
  $data['judul'] = 'dpt';
  $data['url'] = 'dpt/import';
  echo show_my_modal('modals/modal_import', 'import-dpt', $data);
?>
...
var base_url = '<?php echo base_url();?>';
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url ('dpt/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
        ...
        $("#kdkec").change(function (){
            var url = "<?php echo site_url('dpt/add_ajax_desa');?>/"+$(this).val();
            $('#kddesa').load(url);
            return false;
        });
    ...
    function edit_person(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('dpt/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function join_relawan(id)
    {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('dpt/ajax_join')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function view_person(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                var month = date.getMonth(data. _lahir);
                var yy = date.getYear();
    ...
    function save()
	{
	    ...
	    if(save_method == 'add') {
	        url = "<?php echo site_url('dpt/ajax_add')?>";
	    } else {
    ...
    function xdelete_person(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo site_url('dpt/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
