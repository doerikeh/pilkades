<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if  ($page == 'relawan') {echo 'class="active"';} ?>>
        <a href="<?php echo base_url('relawan'); ?>">
          <i class="fa fa-male"></i>
          <span>Data Relawan </span>
        </a>
      </li>
      <li <?php if ($page == 'dpt') {echo 'class="active"';} ?>>
        <a href="<?php echo base_url('dpt'); ?>">
          <i class="fa fa-male"></i>
          <span>Data Dpt </span>
        </a>
      </li>
      ...
      <li <?php if ($page == 'Tabulasi') {echo 'class="active"';} ?>>
        <a href="<?php echo base_url('tabulasi'); ?>">
          <i class="fa fa-table"></i>
